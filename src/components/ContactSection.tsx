        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label className="text-muted-foreground text-xs mb-1 block uppercase tracking-wide">Full Name *</label>
                <Input
              ...
              <div>
                <label className="text-muted-foreground text-xs mb-1 block uppercase tracking-wide">Phone Number *</label>
                <Input
              ...
              <div>
                <label className="text-muted-foreground text-xs mb-1 block uppercase tracking-wide">Email Address</label>
                <Input
                  type="email"
              ...
              <div>
                <label className="text-muted-foreground text-xs mb-1 block uppercase tracking-wide">Type of Case *</label>
                <Select
                  value={form.caseType}
              ...
              <div>
                <label className="text-muted-foreground text-xs mb-1 block uppercase tracking-wide">Brief Description</label>
                <Textarea
              ...
              <button
                type="submit"
                className="w-full px-8 py-4 bg-primary text-primary-foreground font-heading font-semibold text-sm tracking-[0.15em] uppercase hover:bg-gold-light transition-colors"
              >
